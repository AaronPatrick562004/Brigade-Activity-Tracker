...
import { brigadeDistrictStats } from "@/lib/brigade-eco-club-data"
      ...
      <CardContent className="p-0">
        <div className="overflow-x-auto">
          <table className="w-full text-xs sm:text-sm">
            ...
            <tbody>
              {brigadeDistrictStats.map((district) => {
                  ...
                  <tr key={district.district} className="border-b border-gray-100">
                    ...
                    <td className="p-2 sm:p-3">
                      <div className="flex items-center gap-1 sm:gap-2">
                        ...
                        <span className="font-mono text-[10px] sm:text-xs text-gray-500">{coverage}%</span>
                      </div>
                    </td>
