...
import { brigadeActivities, activityTypeLabels } from "@/lib/brigade-eco-club-data"
...
export function ActivityList({ schoolId }: { schoolId?: string }) {
  const activities = schoolId
    ? brigadeActivities.filter((a) => a.projectId === schoolId)
    : brigadeActivities
